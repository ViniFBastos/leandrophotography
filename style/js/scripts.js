...
$(document).ready(function () {
    ...
    $('.banner-home svg').click(function(){
      $('html,body').animate({
        scrollTop: $('.quem-somos').offset().top}, 2000
      );
    });
    $heightHome = $(window).height();
    ...
    $('.banner-home').css('height',$heightHome);
    $('.item-banner').css('height',$heightHome);
    $('.quem-somos').css('height',$heightHome);
    $('.texto-banner').css('height',$heightHome);
    $('.content-texto').css('height',$heightHome);
    $('.text-inner').css('height',$heightHome);
});

$(window).resize(function(){
    $heightHome = $(window).height();
    $('.banner-home').css('height',$heightHome);
    $('.banner-home .item-banner').css('height',$heightHome);
    $('.quem-somos').css('height',$heightHome);
    $('.texto-banner').css('height',$heightHome);
    $('.content-texto').css('height',$heightHome);
    $('.text-inner').css('height',$heightHome);
...
$('.container-clientes').owlCarousel({
                items: 5,
                nav:true,
                navText: ['<i class="icon-left-open-1"></i>','<i class="icon-right-open-1"></i>'],
                dots: false,
...
var instagramFeed = new Instafeed({
        get: 'user',
        userId: 396613020,
        accessToken: '396613020.5b9e1e6.b6f4f789a2144c138e148b9de6b85ba6',
